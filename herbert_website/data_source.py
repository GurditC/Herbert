...
class DataSource_Herb:
    ...
    def __init__(self):
        with open('data/herbert_valid_herb_v11.pickle', 'rb') as handle:
    ...
    def get_all(self):
        ...
        for key, value in self.herb_dict.items():
            ...
            result.append("{}|{}|{}".format(value["english_name"][0], value["herb_id"], chinese_name))
            result.sort()
...
class DataSource_Condition:
    ...
    def __init__(self):
        with open('data/herbert_condition_v11.pickle', 'rb') as handle:
    ...
    def get_all(self):
        result = []
        for key, value in self.cond_dict.items():
            result.append("{}|{}".format(value["condition"], value["condition_id"]))
...
class DataSource_Interaction:
    ...
    def __init__(self):
        with open('data/herbert_interaction_v6.pickle', 'rb') as handle:
